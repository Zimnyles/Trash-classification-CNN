...
def aboutus_frame_create():
    aboutus_frame = Frame(frame)
    aboutus_frame.place(relheight=1, relwidth=1)
    about_us_bg = Label(aboutus_frame, image = bg_for_aboutus)
    about_us_bg.place(relheight=1, relwidth=1)
    back_button = Button(aboutus_frame, text = 'Назад', bg = '#232323' ,font='Arial 13', fg='#ffffff'  )
    back_button.place(x=300,y=630,height=70,width=210)
...
def newbutton1():
    start_classification_button = Button(frame, text = 'Начать классификацию', bg = '#232323', command=lambda:[start_classification()] )
...
bg_for_aboutus = PhotoImage(file='other_images/aboutus.png')
...
about = Button(frame, text = 'О нас',font='Arial 13', fg='#ffffff',bg = '#232323',command = lambda:[aboutus_frame_create()] )
about.place(x=40, y=630, height=70, width=210)
